...
\begin{frame}[t]{Results: \texorpdfstring{\iso{10}{Be}(d,\iso{}{t})\iso{9}{Be} }{10Be(d,t)9Be}}
    \begin{figure}
...
\begin{frame}[t]{Results: \texorpdfstring{\iso{12}{Be}(d,\iso{3}{He})\iso{11}{Li} }{12Be(d,3He)11Li}}
    ...
    \begin{columns}[c]
        ...
        \begin{column}{0.48\linewidth}
            \mycolorbox[1]{box1}{
                No STA predictions.\\
                In contact with N.Timofeyuk to develop them
            }
        \end{column}
    \end{columns}
\end{frame}

\begin{frame}[t]{Overall results}
    ...
    \begin{columns}[T]
        \begin{column}{0.33\linewidth}
            \mycolorbox[0.95]{box3}{
                SM \textbf{compatible} with current systematics!
            }
        \end{column}\hfill
        \begin{column}{0.33\linewidth}
        ...
        \begin{column}{0.33\linewidth}
            ...
            {
                \textbf{STA} improves SRC modelling but falls short
            }
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}[c]{Conclusions}
    \mycolorbox{box3}{
        Angular distributions for \iso{9}{Be,Li} and \iso{11}{Li} have been extracted and compared with DWBA
    }
    \vspace{1em}
