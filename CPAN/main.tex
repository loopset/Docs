...
\section{Results}
\begin{frame}[c]{Results: (In)elastic \texorpdfstring{\iso{10,12}{Be}(d,d)\iso{10,12}{Be} }{10,12Be(d,d)10,12Be}}
    \only<+>{
        The \textbf{ground state} provides a means to test our normalization
        \begin{figure}
        ...
        \begin{columns}[c]
            ...
            \begin{column}{0.5\linewidth}
                \mycolorbox[1]{box4}{
                    ...
                    \begin{itemize}
                        \item $\epsilon \sim$ \qtyrange[range-phrase={\text{--}}, range-units=single]{20}{30}{\percent}
...
\begin{frame}[t]{Results: transfer}
    \only<+>{
        ...
        \end{figure}
        \mycolorbox{box2}{
            \textbf{First} state at \qty{2.7}{\MeV} of \iso{9}{Li} is seen too!
        }
    }%
    \only<+>{
        ...
        \begin{columns}
            \begin{column}{0.5\linewidth}
                ...
                \mycolorbox[1]{box3}{%
                \small
                \boxitem{2} Light overlap {\scriptsize $\langle\iso{}{d}\vert\iso{}{t},\iso{3}{He}\rangle$}: Accurate GFMC\\
