...
\begin{frame}{Physics case}
    ...
    \begin{columns}[c]
        \begin{column}{0.5\linewidth}
            \mycolorbox[1]{box2}{
                \boxitem{1} \textbf{Proton} pickup $\iso{20}{O}(\iso{}{d},\iso{3}{He})\iso{19}{N}$\newline\newline
                some results from Juan and cite
            }
            \vspace*{-0.5cm}
            \mycolorbox[1]{box3}{
                \boxitem{2} \textbf{Neutron} pickup $\iso{20}{O}(\iso{}{d},\iso{}{t})\iso{19}{O}$
                this analysis and .....
            }
        \end{column}%
        \begin{column}{0.5\linewidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.85\linewidth]{figures/sm_20O.pdf}
