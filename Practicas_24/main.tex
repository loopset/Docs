...
Unha vez feito isto, vamos comezar co macro de simulación. O primeiro é adaptar o que acabas de aprender de sampleado:
\begin{itemize}
    \item Define o tamaño de ACTAR ao comezo do macro en \unit{\mm}. En cada iteración, nunha variable tipo \lstinline|XYZPoint| garda:
    \begin{itemize}
...
Fai o mesmo para os ángulos: samplea e crea histogramas para representalos. Vamos utilizalos cando acabes isto.
