...
\begin{frame}[t]{Results: \texorpdfstring{\iso{10}{Be}(d,\iso{3}{He})\iso{9}{Li} }{10Be(d,3He)9Li}}
    ...
    \only<+>{\addtocounter{beamerpauses}{1}
    ...
    \only<+>{
        \begin{itemize}
            ...
            \item Which potentials are we going to use?
            \item Great differences with Pang or HT1p
            \item And then there is the situation with STA or a standard WS
        \end{itemize}
    }
    \only<+>{
