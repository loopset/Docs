...
\begin{frame}[t]{Results: \texorpdfstring{\iso{10}{Be}(d,\iso{3}{He})\iso{9}{Li} }{10Be(d,3He)9Li}}
    ...
    \only<+>{
        Recent experiment @ Acculina by {\small \textit{E. Yu. Nikolskii et al.,  NIM B 541 (2023)}}. Different beam energy of \qty{40}{A\MeV}
        \begin{columns}[T]
            \begin{column}{0.5\linewidth}
    ...
    \only<+>{
        ...
        %     \datavisualization [
        %         scientific axes={inner ticks},
        %         visualize as line/.list={sta, stdws},
        %         style sheet=strong colors,
        %         style sheet=vary dashing,
        %         style sheet=cross marks,
        %         sta={label in legend={text=STA}},
        %         stdws={label in legend={text=stdWS}},
        %         every grid/.append style={style={densely dashed, very thin}},
        %         x axis={label={Potential},include value=0.75, include value=2.25,
        %                 ticks={major at={
        %                                 1 as Pang,
        %                                 2 as HT1p,
        %                             }}},
        %         y axis={grid, ticks={minor steps between steps=1},label={C2S}, include value=1, include value=3}]
        %     data [set=sta, format=TeX code]{
        %             \pgfkeys{/data point/.cd,x=1, y=2.679} \pgfdatapoint
        %             \pgfkeys{/data point/.cd,x=2, y=1.848} \pgfdatapoint
        %         }
        %     data [set=stdws, format=TeX code]{
        %             \pgfkeys{/data point/.cd,x=1, y=2.09} \pgfdatapoint
        %             \pgfkeys{/data point/.cd,x=2, y=1.429} \pgfdatapoint
        %         };
        % \end{tikzpicture}
        \mycolorbox{box4}{
            \begin{tikzpicture}[
...
\begin{frame}[noframenumbering]{Elastic cross sections}
    Normalization of all cross-sections was obtained from fits to the elastic data.
    \begin{columns}[T]
        \begin{column}{0.5\linewidth}
            \begin{tikzpicture}
