...
\begin{frame}[t]{About DWBA calculations}
    ...
    \begin{columns}[c]
        \begin{column}{0.5\linewidth}
            \mycolorbox[0.95]{box2}{
                \raisebox{0.15em}{\enumitem{1}} OMPs for elastic
                \begin{itemize}
        ...
        \begin{column}{0.5\linewidth}
            \mycolorbox[0.95]{box3}{
                \raisebox{0.15em}{\enumitem{2}} Light overlap.
    ...
    \mycolorbox[0.95]{box4}{
        \small{
            \raisebox{0.15em}{\enumitem{3}} Heavy overlap $\langle \iso{10,12}{Be}\vert\iso{9,11}{Be,Li} + \text{n},\text{p}\rangle$. Two WS prescriptions:
            \begin{itemize}
